...
public class EditarPromocionServlet extends HttpServlet implements Servlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/promocion-editar.jsp");
...
//		
//		Excursion excursion = ofertaService.update(id, nombre, costo, tiempo, cupo, tipo_oferta, fileName, descripcion);
//
//		
